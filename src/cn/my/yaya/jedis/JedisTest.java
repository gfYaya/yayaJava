...
public class JedisTest {
    ...
    public void testKey() throws InterruptedException{
        System.out.println("清空数据:"+jedis.flushDB());// clear all the data in the memory
        ...
        // The -2 for the TTL of the key means that the key does not exist (anymore). A -1 for the TTL of the key means that it
        //    will never expire. Note that if you SET a key, its TTL will be reset.
